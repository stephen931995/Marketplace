                                ...
                                filtered.map((opt) => (
                                    ...
                                    >
                                        <input
                                            ...
                                            onChange={() => toggle(opt)}
                                            style={{ width: '14px', height: '14px', accentColor: '#249edc' }}
                                        />
                                        <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                            {opt}
                                        </span>
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
            ...
            <div style={{
                ...
                <button
                    onClick={onBack}
                    style={{ display: 'flex', alignItems: 'center', gap: '7px', background: 'none', border: 'none', color: 'rgba(255,255,255,0.6)', cursor: 'pointer', marginBottom: '28px', fontSize: '14px', fontWeight: 500, padding: 0 }}
                >
                    <ChevronLeft size={16} /> Back to Marketplace
                </button>

                <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                    <Activity size={32} color="#6ec9eb" />
                    <div>
                        <h1 style={{ fontSize: '28px', fontWeight: 700, margin: '0 0 6px 0', color: '#fff', letterSpacing: '-0.5px' }}>
                            User Activity
                        </h1>
                        <p style={{ margin: 0, color: 'rgba(255,255,255,0.60)', fontSize: '14px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '16px', marginBottom: '28px' }}>
                <StatCard icon={<Activity />}    label="Total Sessions"      value={totalSessions}            color="#249edc" />
                <StatCard icon={<Users />}        label="Unique Users"        value={uniqueUsersCount}         color="#6ec9eb" />
                <StatCard icon={<Calendar />}     label="Today's Sessions"    value={todaySessions}            color="#11567F" sub={formatDate(todayStr)} />
                <StatCard
                    icon={<TrendingUp />}
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', gap: '8px', alignItems: 'flex-end' }}>
                    <button
                        onClick={handleApply}
                        style={{ padding: '9px 20px', background: '#249edc', color: '#fff', border: 'none', borderRadius: '8px', fontWeight: 600, fontSize: '13px', cursor: 'pointer', boxShadow: '0 1px 2px rgba(36,158,220,0.22)' }}
                    >
                        Apply
                    </button>
                    <button
                            ...
                            <tbody>
                                {paginatedLogs.map((log, i) => (
                                    <tr
                                        ...
                                        onMouseEnter={(e) => (e.currentTarget.style.background = '#e0f3fb')}
                                        ...
                                        <td style={{ padding: '14px 24px' }}>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                                <div style={{
                                                    ...
                                                    background: '#e0f3fb', color: '#249edc',
